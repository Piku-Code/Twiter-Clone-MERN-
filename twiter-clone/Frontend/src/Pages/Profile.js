...
const Profile = () => {
  ...
  //     const response = await axios.get(`http://localhost:5000/getUser/${uId}`, CONFIG_OBJ);
  
  //     if (response.status === 200) {
  //       setUser(response.data.user); 
  //       console.log('Fetched user data:', response);
  //       // Do something with the user data, such as updating state in your component
  //     } else {
                        ...
                        <div className='d-flex'>
                          ...
                          <div style={{ marginLeft: '10px' }}>
                            <Card.Title>
                              ...
                              <span style={{ fontSize: '12px', fontWeight: 'normal', color: 'grey', marginLeft: '5px' }}>. Aug 13 2023</span>
